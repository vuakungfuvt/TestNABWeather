...
//  TestNABWeatherTests
//
//  Created by tungphan on 12/04/2022.
//
...
class ConfigurationTest: XCTestCase {
    ...
    func testSavedSetting() {
        let setting = Setting(fontSize: 14, countDay: 7, unitTemp: UnitTemp.Celsius.rawValue)
        Configuration.shared.saveSetting(setting: setting)
